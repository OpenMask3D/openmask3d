...
class SemanticSegmentationDataset(Dataset):
    ...
    def __init__(
        ...
        data_dir: Optional[Union[str, Tuple[str]]] = "/local/home/efedele/clean/Mask3D/data/processed/scannet",
        label_db_filepath: Optional[
            str
        ] = "/local/home/efedele/clean/Mask3D/data/processed/scannet/label_database.yaml",
